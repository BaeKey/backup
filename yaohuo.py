...
def get_content(url):
    try:
        ...
        yaohuo_content = etree.HTML(response.content).xpath('//div[@class="bbscontent"]/text()')
        return yaohuo_content
...
def main():
    ...
    while True:
        try:
            ...
            href_list = xml_content.xpath('//div[contains(@class, "listdata line")]/a[1]/@href')
            reply_number = xml_content.xpath('//div[contains(@class, "listdata line")]/a[2]/text()')
            href = xml_content.xpath('//div[contains(@class, "listdata line")]/a[1]/text()')
